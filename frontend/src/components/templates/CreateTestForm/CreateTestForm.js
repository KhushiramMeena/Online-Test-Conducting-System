...
import { getSubjectDetails } from '../../../redux1/actions/subjectAction';
import { setAlert } from "../../../redux1/actions/alertAction";
import { createTestAction } from "../../../redux1/actions/teacherTestAction";
...
class CreateTestForm extends React.Component {
  ...
  handleSubmit(event) {
    ...
    } else if((Date.parse(this.state.endTime) - Date.parse(this.state.startTime +1) - dur) <= 0) {
